...
### get_nonomics_value()
A function to fetch the non-omics data `c("immune", "pathway", "tumor_index")` for samples of 3 databases `c("toil", "pcawg", "ccle")`.

- For "immune" type of toil/pcawg database, one of "CIBERSORT", "CIBERSORT-ABS", "EPIC", "MCPCOUNTER", "QUANTISEQ", "TIMER", "XCELL". 
