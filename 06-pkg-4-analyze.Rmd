...
```{r vis-toil-TvsN, message=FALSE, fig.cap='The difference of mRNA TP53 across pan-cancer', out.width='80%',  fig.align='center', fig.height=6, fig.width=10}
...
```{r vis-toil-TvsN-cancer, message=FALSE, fig.cap='The difference of mRNA TP53 in ACC cancer', out.width='80%', fig.align='center', fig.height=6, fig.width=6}
...
```{r vis-toil-Mut, message=FALSE, fig.cap='The difference of mRNA TNF between TP53-mut and TP53-wild tumor samples across pan-cancer', out.width='80%', fig.align='center', fig.height=6, fig.width=10}
...
```{r vis-toil-Mut-cancer, message=FALSE, fig.cap='The difference of mRNA TNF between TP53-mut and TP53-wild tumor samples in BRCA cancer', out.width='80%', fig.align='center', fig.height=6, fig.width=6}
...
```{r vis-gene-cor, message=FALSE, fig.cap='The correlation between mRNA CSF1R and mRNA JAK3 in tumor samples of pan-cancers', out.width='80%', fig.align='center'}
...
```{r vis-gene-cor-cancer, message=FALSE, fig.cap='The correlation between mRNA CSF1R and mRNA JAK3 in tumor samples of ACC cancer', out.width='80%', fig.align='center'}
...
```{r vis-gene-TIL-cor, message=FALSE, fig.cap='The correlation between mRNA TP53 and TIMER TIL in tumor samples across pan-cancers', fig.align='center',fig.height=3, fig.width=12}
...
```{r vis-gene-immune-cor, message=FALSE,warning=FALSE, fig.cap='The correlation between mRNA TP53 and Cibersort signature in tumor samples across pan-cancers', fig.align='center',fig.height=6, fig.width=12}
...
```{r vis-gene-tmb-cor, message=FALSE, fig.cap='The correlation between mRNA TP53 and TMB score in tumor samples across pan-cancers', fig.align='center',fig.height=2, fig.width=12}
...
```{r vis-gene-msi-cor, message=FALSE, fig.cap='The correlation between mRNA TP53 and MSI score in tumor samples across pan-cancers', fig.align='center',fig.height=2, fig.width=12}
...
```{r vis-gene-stemness-cor, message=FALSE, fig.cap='The correlation between mRNA TP53 and stemness score in tumor samples across pan-cancers', fig.align='center',fig.height=2, fig.width=12}
...
```{r vis-gene-pw-cor, message=FALSE, fig.cap='The correlation between mRNA TP53 and pathway score in tumor samples in ACC cancer', fig.align='center',fig.height=6, fig.width=6}
...
```{r tcga-surv-plot, message=FALSE, fig.align='center', fig.cap='The log-rank test (DSS) of mRNA TP53 for LUAD cancer', fig.height=7, fig.width=6, message=FALSE}
...
```{r vis-unicox-tree, message=FALSE, fig.cap='The Cox regression analysis (OS) of mRNA PTEN across pan-cancers', fig.align='center',fig.height=6, fig.width=6}
