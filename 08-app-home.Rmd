...
```{r tcga-modules, fig.cap='12 TCGA analytical modules',  fig.align='center', echo = FALSE,out.width="100%"}
knitr::include_graphics('images/p0802.png')
```

```{r tcga-pipelines, fig.cap='3 TCGA analytical pipelines',  fig.align='center', echo = FALSE,out.width="100%"}
