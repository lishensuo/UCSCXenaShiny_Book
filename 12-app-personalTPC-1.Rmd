...
About the core data type —— **Molecular profile**, the initial step of all analysis pipelines involves the check and modification of molecular datasets through the `Modify datasets[opt]` widget. For some molecular types of TPC databases, there are alternative datasets for users to select, which greatly enriches the analytical possibilities
